...
if (isset($_POST['submit'])) {
    $nama = $_POST['nama'];
    $email = $_POST['email']; // Perbaikan nama variabel
    $ulasan = $_POST['ulasan'];
    $rating = $_POST['rating'];

    // Query untuk menyimpan data ke tabel ulasan
...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Kanit:ital,wght@0,
    100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,
    400;1,500;1,600;1,700;1,800;1,900&family=Signika+Negative:wght@300..700&display=swap"
      rel="stylesheet"
    />
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
      ...
      <div class="main">
          ...
          <div class="fitur-con">
            <div class="fitur-container">
              ...
              <div class="fiturHidden a2">
                <a href="#">
                  <div class="fitur">
                    <img src="../image/homelab.webp" alt="" />
                    <p>Home Lab & Vaksinasi</p>
                  </div>
                </a>
              </div>
        ...
        <div class="baris">
          <div class="artikel-judul">
            ...
            <a href="artikel.html"><p>lihat semua</p></a>
          </div>

          <div class="artikel-grid">
            <a href="artikel-demam.html">
            ...
            <a href="artikel-minum-susu.html">
              <div class="artikel-card">
            ...
            <a href="artikel-hidup-sehat.html">
              <div class="artikel-card">
